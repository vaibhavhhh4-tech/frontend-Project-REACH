    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1.5 max-w-2xl text-muted-foreground">
          Central and state schemes matched to your business profile, location
          and requested loan.
        </p>
      </div>
      ...
      >
        <p className="text-sm leading-relaxed text-muted-foreground">
          We matched your dairy unit (₹2,00,000 loan, rural Barabanki) against
          scheme rules — sector, loan ceiling, location and applicant category.
          Schemes are ranked by how well their subsidy, tenure and moratorium
          fit your projected cash flow. Eligibility shown here is indicative;
          final approval rests with the lending bank.
        </p>
      </Disclosure>
          ...
          return (
            <Card key={scheme.id} className="flex flex-col p-5 sm:p-6">
              <div className="flex items-start justify-between gap-3">
                ...
                <Badge
                  variant={scheme.eligible ? "success" : "outline"}
                  className="shrink-0"
                >
                  {scheme.eligible ? (
              ...
              <div className="mt-5 pt-1">
                <Action
                  variant={scheme.eligible ? "primary" : "outline"}
